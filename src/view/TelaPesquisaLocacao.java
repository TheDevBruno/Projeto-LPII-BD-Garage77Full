...
public class TelaPesquisaLocacao extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaPesquisaLocacao.class.getName());

    public TelaPesquisaLocacao() {
